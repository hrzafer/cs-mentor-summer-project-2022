...
export class InfraStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    const hello = new lambda.Function(this, "FocusTrackerLambdaFunction", {
      functionName: "FocusTrackerLambdaFunction",
    ...
    const api = new apigw.LambdaRestApi(this, "FocusTrackerApiGateway", {
